          ...
          <div class="col-md-4">
            ...
            <div class="col-md-4">
              <form enctype="multipart/form-data"  action="upload.php" method="post">
                <input type="hidden" name="size" value="99999999"/>
                <div>
                ...
                <div>
                 ...
                 <br>
                 <div>
                  <input type="text" class="form-control" name="categoria" placeholder="Category">
                </div>
                <br>
                <div>
                  <input type="text" class="form-control" name="horario" placeholder="Time">
                </div>
                <br>
                <div>
                ...
                <br>
                <div>
                  <input type="text" class="form-control" name="information" placeholder="Description">
                </div>
                <br>
                <div>
                   <button name="upload" class="btn btn-lg btn-primary btn-block" type="submit">Save</button>
                </div>
              </form> 
              </div>
              </div>
